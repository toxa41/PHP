...
$tel = '8963246525';
$skills = ['97%', '83%', '70%', '88%'];
$job = ['Senior - начальник, босс проекта', 'Middle - серьезный человек', 'Junior - разработчик'];
$date = ['Январь.2015 - ', 'Настоящее время','March.2012 - December.2014', 'Где-то в самом начале 2010 - 03.2012'];
$description = ['Разработка, верстка, управление целым подразделением. Выполнение сложных проектов', 'Управление проектами, ведение технической документации', 'Python - разработчик, базовый уровень'];
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $string;?></p>
